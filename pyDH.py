...
class DiffieHellman:
    ...
    def gen_shared_key(self, other_contribution):
        ...
        if self.check_other_public_key(other_contribution) and other_contribution != self.gen_public_key():
            self.shared_key = pow(other_contribution, self.__a, self.p)
            return self.shared_key
        elif other_contribution == self.gen_public_key():
            raise Exception("the public key sent is the same public key this key have")
        else:

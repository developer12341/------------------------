...
while True:
    ...
    # key = hashlib.sha256(pac_comp.int_to_bytes(shared_secrete)).hexdigest().encode("utf-8")
    
    thread = client_thread.request_heandler(client,addr,shared_secrete,data_base, chatId_cli, chatId_cli, chatid_pubkey,user_list)
